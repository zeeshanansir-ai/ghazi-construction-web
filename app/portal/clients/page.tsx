    ...
    <div className="space-y-8">
      ...
      <div className="bg-surface rounded-2xl border border-outline-variant">
        ...
        <div className="divide-y divide-outline-variant">
          {LEADS.map(l => (
            <div key={l.name} className="p-5 flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[12px] text-on-surface-variant">{l.note}</div>
              </div>
      ...
      <div className="bg-surface rounded-2xl border border-outline-variant">
        <div className="flex items-center justify-between p-5 border-b border-outline-variant">
          ...
          <button className="text-[12px] text-on-surface-variant flex items-center gap-1 hover:text-primary transition-colors">
